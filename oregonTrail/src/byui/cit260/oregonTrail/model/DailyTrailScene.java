...
public class DailyTrailScene implements Serializable {
    ...
    public String toString() {
        return "DailyTrailScene{" + "currentPlantPresence=" + currentPlantPresence + ", currentAnimalPresence=" + currentAnimalPresence + ", currentHazards=" + currentHazards + ", currentDate=" + currentDate + ", currentWeather=" + currentWeather + ", currentLocation=" + currentLocation + '}';
    }
